...
def register_hospice_routes(app: web.Application, config: dict):
    ...
    routes = [
        ...
        web.post("/api/hospice/voice-clone/reset", handler.handle_voice_clone_reset),
        ...
        web.post("/api/hospice/pairing/code", handler.handle_pairing_code),
        web.post("/api/hospice/pairing/bind", handler.handle_pairing_bind),
        web.get("/api/hospice/pairing/families", handler.handle_pairing_families),
        web.delete("/api/hospice/pairing/bindings", handler.handle_pairing_unbind),
        ...
        web.get("/api/hospice/interview/audio-segments/latest", handler.handle_interview_audio_segments),
        web.post("/api/hospice/interview/audio-segments/save", handler.handle_interview_audio_segments_save),
        web.get("/api/hospice/legacy-card/latest", handler.handle_legacy_card_latest),
        web.post("/api/hospice/legacy-card/render", handler.handle_legacy_card_render),
        web.get("/api/hospice/family-letter/latest", handler.handle_family_letter_latest),
        ...
        web.patch("/api/hospice/video/assets", handler.handle_video_asset_update),
