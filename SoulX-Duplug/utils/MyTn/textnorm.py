...
def process_text(text: str, lang: str) -> str:
    # Lazy imports: pypinyin and WeTextProcessing (tn) depend on pynini which is Linux-only.
    # This function is NOT used in the inference path, so we import only when called.
